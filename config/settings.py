...
# ==================== УПРАВЛЕНИЕ ПОРТФЕЛЕМ (BYBIT) ====================
PORTFOLIO_CONFIG = {
    # Источник данных
    'source': 'bybit',  # 'bybit' или 'manual'
    
    # Базовая валюта (в которой мы считаем стоимость портфеля)
    'base_currency': 'USDT',
    
    # Минимальный ордер на Bybit обычно $5-10, ставим с запасом
    'min_trade_amount_usd': 15.0,
    
    # Порог ребалансировки (5%)
    'rebalance_threshold_pct': 0.05, 
    
    # Максимальное количество монет в портфеле
    'max_assets': 12
}
